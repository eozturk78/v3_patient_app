...
class Questionnaire3Page extends StatefulWidget {
  const Questionnaire3Page({super.key});

  @override
  State<Questionnaire3Page> createState() => _Questionnaire3PageState();
}

class _Questionnaire3PageState extends State<Questionnaire3Page> {
  int _groupValue = -1;
