...
class Registration5Page extends StatefulWidget {
  ...
  @override
  State<Registration5Page> createState() => _Registration5PageState();
}

class _Registration5PageState extends State<Registration5Page> {
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          Navigator.of(context).pushNamed('/registration-6');
                        },
