...
class _CustomMessageTextBubbleState extends State<CustomMessageTextBubble> {
  ...
  saveLoad() {
    ...
    /* int secDuration = widget.index != null ? (widget.index! * 1) : 1;
    Future.delayed(Duration(seconds: secDuration), () {
      apis.getAttachmentDataUrl(widget.image).then(
        (value) {
          imageText = value;
          widget.startedLoadImage = false;
  ...
  Widget build(BuildContext context) {
    return VisibilityDetector(
      ...
      onVisibilityChanged: (visibilityInfo) {
        ...
        if (imageText == null && widget.image != null && visiblePercentage > 90)
          saveLoad();
        debugPrint(
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    color:
                        widget.senderType == 20 ? Colors.white : Colors.black,
