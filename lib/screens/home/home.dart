          ...
          children: [
            ...
            GestureDetector(
              child: const CustomListComponent(
                  ...
                  20),
              onTap: () {
                Navigator.of(context).pushNamed('/measurement-result-weight');
              },
            ),
            GestureDetector(
              child: const CustomListComponent(
                  ...
                  10),
              onTap: () {
                Navigator.of(context).pushNamed('/measurement-result-pulse');
              },
            ),
            GestureDetector(
              child: const CustomListComponent(
            ...
            GestureDetector(
              child: const CustomListComponent(Icons.air, "Sauerstoffsättigung",
                  "Heute: - %", "Bitte tägliche Messung durchführen", 10),
              onTap: () {
                Navigator.of(context)
