...
class BluetoothExamplePage3 extends StatefulWidget {
  const BluetoothExamplePage3({Key? key}) : super(key: key);

  @override
  State<BluetoothExamplePage3> createState() => _BluetoothExamplePage3State();
}

class _BluetoothExamplePage3State extends State<BluetoothExamplePage3> {
