          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "NUTZUNGSBEDINGUNGEN\nder iMedComV3-imc-Patienten-App",
                ...
                Text(
                  '(1)	Die iMedComV3-App (im Folgenden als "App" oder "iMedComV3" bezeichnet) sowie die damit verbundenen Dienste, Inhalte und Services werden von der iMedComV3 GmbH, Weinbergweg 23, 06120 Halle an der Saale betrieben. \n\n(2)	Die Nutzung von iMedComV3 und ihren Inhalten erfordert die vorherige ausdrückliche Einwilligung in diese Nutzungsvereinbarung und die Kenntnisnahme der Gebrauchsanweisung. Für die rechtmäßige Verarbeitung der  personenbezogenen Daten im Rahmen der bestimmungsgemäßen iMedComV3 Nutzung ist zudem die Abgabe einer ausdrücklichen Einwilligung des betroffenen Nutzers erforderlich. \n\n(3)	Der Schutz der persönlichen Nutzerdaten hat für iMedComV3 höchste Priorität. Wir handeln in Übereinstimmung mit den geltenden Datenschutzbestimmungen und setzen uns für die Sicherheit der Daten ein. Diese Nutzungsvereinbarung informiert die Nutzer über den Anwendungsbereich, Haftungsfragen und Verantwortlichkeiten.\n\n(4)	Alle von iMedComV3 angebotenen Leistungen stellen weder eine ärztliche Beratung noch eine medizinische Diagnose dar. Sie sind kein Ersatz für eine Untersuchung oder Behandlung durch einen Arzt oder Therapeuten. Bei medizinischen Rückfragen wird dringend empfohlen, einen Arzt zu konsultieren.\n\n(5)	Aus Gründen der Darstellung und Lesbarkeit wurde in dieser Nutzungsvereinbarung und in allen unseren Produkten die männliche Form verwendet. Dies dient ausschließlich der besseren Lesbarkeit und beinhaltet keine Diskriminierungsabsicht. Es sind immer alle Geschlechter gleichermaßen gemeint und einbezogen.',
                  style: TextStyle(fontSize: 16),
                ),
                SizedBox(
                  height: 20,
                ...
                Text(
                  "§ 5 Zweckbestimmung der iMedComV3-Patienten-App",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),
                ),
                SizedBox(
                  height: 20,
                ...
                Text(
                  '(1)	Die bereitgestellten Informationen von iMedComV3 werden sorgfältig geprüft und basieren auf aktuellem Wissensstand. Dennoch liegt die Nutzung von iMedComV3 und die Befolgung der Handlungsempfehlungen in der alleinigen Verantwortung des Nutzers und erfolgt auf eigenes Risiko. Bei spezifischen Fragen zur Behandlung, Pflege oder bei Beschwerden sollten Sie sich bitte an Ihren Arzt oder Therapeuten wenden.\n\n(2)	iMedComV3 schließt, soweit gesetzlich zulässig, die Haftung für Sach- und Rechtsmängel aus. In Fällen von Vorsatz oder grober Fahrlässigkeit seitens iMedComV3 oder eines Erfüllungsgehilfen haftet iMedComV3 gemäß den gesetzlichen Bestimmungen, wenn dem Nutzer durch die Nutzung der iMedComV3-App ein Schaden entsteht. Bei Fahrlässigkeit seitens iMedComV3 oder eines Erfüllungsgehilfen haftet iMedComV3 nur bei Verletzung von Leben, Körper, Gesundheit oder wesentlicher Vertragspflichten, deren Erfüllung die ordnungsgemäße Durchführung der Nutzungsvereinbarung überhaupt erst ermöglicht, sowie in Fällen einer zwingenden Haftung nach dem Produkthaftungsgesetz. Der Schadensersatzanspruch wegen Verletzung wesentlicher Vertragspflichten ist auf den vorhersehbaren Schaden begrenzt, der für solche Verträge typisch ist.\n\n(3)	iMedComV3 haftet ausdrücklich nicht für Fehlleistungen Dritter oder des Nutzers, insbesondere in Bezug auf die Funktion und Bedienung der bereitgestellten Software.',
                  style: TextStyle(fontSize: 16),
                ),
                SizedBox(
                  height: 20,
